             ...
             <div class="col-md-12 order-md-last d-flex">
               ...
               <form method="POST" action="{{ route('register') }}" class="bg-white p-5 contact-form">
                 ...
                 <div class="form-group">
                    ...
                    <input class="form-control block mt-1 w-full"   type="text" name="name" value="{{old('name')}}" required autocomplete="username" >
                 ...
                 <div class="form-group">
                    ...
                    <input class="form-control block mt-1 w-full"   type="email" name="email" value="{{old('email')}}" required autocomplete="username" >
                  
                    <x-input-error :messages="$errors->get('email')" class="mt-2" />
                 </div>
                 <div class="form-group">
                    <x-input-label for="password" :value="__('Password')" />
                    <input class="form-control block mt-1 w-full"
