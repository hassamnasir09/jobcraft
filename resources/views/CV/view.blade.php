                ...
                <div class="card mb-5">
                    <div class="card-header">
                        <h3 class="card-title ">
                            ...
                            Profile
                            <button class="btn btn-success" style="float:right" onclick="exportToPDF()">Export to PDF</button>
                        </h3>
                        ...
                        <div class="container-fluid wrapper">
                            <div class="row">
                                <div class="sidebar-wrapper col-4">
                                    ...
                                    <div class="education-container container-block" style="padding-left10px ">
                                        <h2 class="container-block-title">Gender</h2>
                                        <div class="item">
                                            <h5 class="meta">
                                                {{ Auth::user()->gender}}
                                            </h5>
