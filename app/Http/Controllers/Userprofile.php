...
class Userprofile extends Controller
{
    ...
    {
        $personal_information   = PersonalInformation::where('user_id',\Auth::id())->get()->toArray();
    ...
    public function view($id,$template=null)
    {
        if($template==null){
            return view('CV.choose',compact('id'));
        }
        if (!empty($id)) {
        ...
        return view('CV.'.$template, ['information' => $info]);
    }
